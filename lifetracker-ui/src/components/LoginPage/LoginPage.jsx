...
const LoginPage = ({onLogin, loginError}) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const loggedinBoolean = await onLogin(email, password);
  ...
  return (
    <div className="outer-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        />
        <button className="Submitbttn" type="submit">Login</button>
        </div>
      </form>
    </div>
  )
